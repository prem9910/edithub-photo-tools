...
?>
    ...
    <section class="text-blueGray-700 bg-white mt-20">
        <div class="container flex flex-col items-center px-5 py-16 mx-auto md:flex-row lg:px-28">
            <div class="flex flex-col items-start mb-16 text-left lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:mb-0">
                <h2 class="mb-8 text-xs font-semibold tracking-widest text-black uppercase title-font"> Online Photo
                    Editing Tools </h2>
                <h1 class="mb-8 text-2xl font-black tracking-tighter text-black md:text-5xl title-font leading-loose">
                    Revamp Photos Effortlessly with Our Intuitive Editing Tools! </h1>
                <p class="mb-8 text-base leading-relaxed text-left text-blueGray-600 "> Enhance Your Images in Moments,
                    Not Hours. Our Photo Editing Tools Provide a Diverse Range of Customizable Features for Your
                    Creative Canvas. </p>
                <div class="flex flex-col justify-center lg:flex-row">
                    <button
                        class="flex items-center px-6 py-2 mt-auto font-semibold text-white transition duration-500 ease-in-out transform bg-orange-600 rounded-lg hover:bg-orange-700 focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2"><a
                            href="./photoedit/index.html" target="_BLANK">Try Now</a></button>
                </div>
            </div>
            <div class="w-full lg:w-1/3 lg:max-w-lg md:w-1/2">
                <img class="object-cover object-center rounded-lg " alt="hero" src="includes/images/header_img.svg">
            </div>
        </div>
    </section>
    <!-- header section end -->
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-12 lg:mb-20 max-w-[510px]">
                        <span class="font-semibold text-lg text-orange-600 mb-2 block">
                            Our Services
                        </span>
                        <h2 class="
                  font-bold
        ...
        <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
            <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                ...
                <div class="md:7/12 lg:w-6/12">
                    <h2 class="mb-5 text-lg font-semibold tracking-widest text-orange-500 uppercase title-font"> About
                        Us </h2>
                    <h2 class="text-2xl text-gray-900 font-bold md:text-4xl">Elevate Your Visual Journey</h2>
                    <p class="mt-6 text-gray-600">At <span class="text-lg font-bold">EditHub</span>, we are
                        passionate about empowering your creativity through innovative photo editing tools. With a
                        commitment to simplicity and functionality, our intuitive platform enables you to transform
                        ordinary photos into extraordinary visual stories. Dive into a world where editing becomes an
                        art form, and every click brings your imagination to life. Join us on this exciting visual
                        journey and discover the endless possibilities that await. </p>
                    <p class="mt-4 text-gray-600">Welcome to a space where your photos are not just edited; they are
                        transformed into timeless masterpieces.</p>
                    <p class="mt-2 text-md text-left text-orange-600 md:mt-0">
                        <a href="#"
                            class="inline-flex items-center font-semibold text-orange-600 mt-6 md:mb-2 lg:mb-0 hover:text-black "
    ...
    <div class="flex flex-col items-center justify-center min-h-screen p-10 text-gray-700 bg-gray-100 md:p-20">
        <h2 class="text-2xl font-medium">EditHub Order Membership</h2>
        ...
        <div class="flex flex-wrap items-center justify-center w-full max-w-4xl mt-8">
            ...
            <div class="flex flex-col flex-grow mt-8 overflow-hidden bg-white rounded-lg shadow-lg">
                <div class="flex flex-col items-center p-10 bg-gray-200">
                    <span class="font-semibold">Basic Package</span>
                    <div class="flex items-center">
                        <span class="text-3xl">Rs.</span>
                ...
                <div class="p-10">
                    <ul>
                        <li class="flex items-center">
                            ...
                            <span class="ml-2">One Tool Available</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                            <span class="ml-2">1GB Storage</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                ...
                <div class="flex px-10 pb-10 justfy-center">
                    <button class="flex items-center hover:bg-orange-500 hover:text-white justify-center w-full h-12 px-6 text-sm uppercase bg-gray-200 rounded-lg">Join now</button>
                </div>
            </div>

            <!-- Tile 2 -->
            <div class="z-1 flex flex-col flex-grow mt-8 overflow-hidden transform bg-white rounded-lg shadow-lg md:scale-110">
                <div class="flex flex-col items-center p-10 bg-gray-200">
                    <span class="font-semibold">Pro Package</span>
                    <div class="flex items-center">
                        <span class="text-3xl">Rs.</span>
                ...
                <div class="p-10">
                    <ul>
                        <li class="flex items-center">
                            ...
                            <span class="ml-2 italic">Three Tools Available</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                            <span class="ml-2">5GB Storage</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                ...
                <div class="flex px-10 pb-10 justfy-center">
                    <button class="flex items-center bg-orange-500 text-white justify-center w-full h-12 px-6 text-sm uppercase bg-gray-200 rounded-lg">Join now</button>
                </div>
            </div>
            ...
            <div class="flex flex-col flex-grow mt-8 overflow-hidden bg-white rounded-lg shadow-lg">
                <div class="flex flex-col items-center p-10 bg-gray-200">
                    <span class="font-semibold">Premium Package</span>
                    <div class="flex items-center">
                        <span class="text-3xl">Rs.</span>
                ...
                <div class="p-10">
                    <ul>
                        <li class="flex items-center">
                            ...
                            <span class="ml-2">Unlimited Tool Available</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                            <span class="ml-2">10GB+ Storage</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                ...
                <div class="flex px-10  pb-10 justfy-center">
                    <button class="flex hover:bg-orange-500 hover:text-white items-center justify-center w-full h-12 px-6 text-sm uppercase bg-gray-200 rounded-lg">Join now</button>
                </div>
            </div>
        </div>
        <!-- Component End  -->
        ...
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form action="#" class="space-y-8">
                <div>
                    ...
                    <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="name@support.com" required>
                </div>
                <div>
                ...
                <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-orange-600 sm:w-fit hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
            </form>
        </div>
    </section>
